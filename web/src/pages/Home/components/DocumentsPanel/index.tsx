...
export function DocumentsPanel({
  ...
  return (
    <Panel>
      ...
      <div className="flex flex-col gap-4 border-b border-zinc-100 p-5 md:flex-row md:items-start md:justify-between">
        <div className="flex items-center gap-3">
          <span className="grid size-10 place-items-center rounded-2xl bg-zinc-100 text-zinc-700">
      ...
      <div className="p-5">
        ...
        {isError && (
          <div className="mx-auto flex max-w-md items-center gap-3 rounded-2xl border border-red-200 bg-red-50 p-4 text-red-700">
      ...
      <div
        className="m-5 mt-0 rounded-2xl border border-dashed border-zinc-200 bg-zinc-50 px-4 py-3 text-sm text-zinc-500"
        onDragEnter={(event) => {
      ...
      >
        <div className="flex items-center gap-3">
          <span className="grid size-9 place-items-center rounded-xl bg-white text-zinc-600 shadow-sm">
